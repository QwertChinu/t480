...
alias upd="paru -Qqe > ~/.local/bin/pkg && cfg commit -am 'System update' && cfg push && pass cfg push && updm && paru -Syu && sudo paru -Sc && sudo fstrim -a -v && updblocks 36 && updblocks 37 && updblocks 38"
alias e="lf"
